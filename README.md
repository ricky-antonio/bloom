...
The scope is intentionally session-only — no persistence, no auth — because those problems are solved. The interesting problems here are performance, perception, and making an AI interaction feel alive rather than transactional.
...
Ring 3 is never AI-generated — it emerges purely from node promotion. This keeps token usage low and prompts simple without sacrificing graph depth.
